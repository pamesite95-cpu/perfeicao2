...
export default function Hero() {
  ...
  <p className="text-xl md:text-2xl font-medium mb-6" style={{ color: '#e75480' }}>Joias que eternizam momentos especiais</p>
      <a href="https://wa.me/5591988534110" target="_blank" rel="noopener" className="px-8 py-3 bg-pink-600 text-white rounded-full shadow-lg hover:bg-pink-700 transition">Peça pelo WhatsApp</a>
    </section>
  );
}
