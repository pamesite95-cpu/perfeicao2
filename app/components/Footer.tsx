    ...
    <footer className="bg-pink-700 text-white py-8 mt-16">
      <div className="flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-4">
        ...
        <div className="flex gap-6">
          <a href="https://www.instagram.com/pamelapaola_shop?igsh=MWR0OGdzcTJjcW05OQ==" target="_blank" rel="noopener" className="hover:text-pink-300 text-2xl"><FaInstagram /></a>
